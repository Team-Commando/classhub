import {upred} from "./commmonui.js";
export var dUpred = {};
...
class UpredDices {
    constructor(){
        ...
        this.areaTag=document.getElementById('DICES_WORKAREA');
    ...
    ShowSum(){
        ...
        if(ca.style.display=='block'){
            ...
            upred.ui.uiModule.SelectButton(dUpred.dices.sumButton);
        }
    }
    AddHexa(){
...
dUpred.dices = {
    ...
    Startup:function(){
        ...
        let buttons={
            showSum:{
                img: '/assets/dices/icon_sum.png',
                txt: '합계보기',
                handler: upDices.ShowSum.bind(upDices)
            },
            addDeca:{
                img: '/assets/dices/icon_decahedron.svg',
                txt: '십면주사위',
                handler: upDices.AddDeca.bind(upDices)
            },
            addHexa:{
                img: '/assets/dices/icon_hexahedron.svg',
                txt: '육면주사위',
                handler: upDices.AddHexa.bind(upDices)
            },
            roll:{
                img: '/assets/dices/icon_roll.png',
                txt: '굴리기',
        ...
        upDices.areaTag.appendChild( upDices.renderer.domElement );
        upDices.RenderScene();
        upred.ui.GuideViewer.Show('/assets/dices/guide.png');
    }
};
dUpred.dices.Startup();